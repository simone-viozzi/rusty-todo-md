...
## src/cli.rs
* [src/cli.rs:228](src/cli.rs#L228): add a flag to enable debug logging
* [src/cli.rs:391](src/cli.rs#L391): simplify this, maybe move to git_utils and maybe do not check if content changed but just try to add it and ignore errors in case it was not modified
